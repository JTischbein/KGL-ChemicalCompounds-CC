...
[IMPORTANT](https://www.youtube.com/watch?v=dQw4w9WgXcQ): To run the scripts properly and ensure that every path works correctly, you have to be in the directory of the script and then run it. For further information, check out our [documentation](https://www.youtube.com/watch?v=o-YBDTqX_ZU).
